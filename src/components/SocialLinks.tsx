...
const SocialLinks = () => {
  return (
    <div className='fixed bottom-8 right-8 z-50 flex gap-x-2 bg-[#6989BE] opacity-90 rounded-xl p-2 shadow-lg hover:opacity-100 transition-opacity'>
      <a href="https://www.instagram.com/ittalker.academy?igsh=MTNrbGh0b3k5NTlmbg==" target="_blank" rel="noopener noreferrer">
        <Image 
      ...
      <a href="https://t.me/ittacademy" target="_blank" rel="noopener noreferrer">
        <Image 
