        ...
        <AnimatedSection direction="up">
          <div className="max-w-[91.625rem] mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h1 className="text-[2.78rem] font-semibold leading-[129%] tracking-[-0.01em] text-[#010024] mb-6">
                ...
                <div className="flex items-center gap-4 mb-12">
                  {badges.map((badge, index) => (
                    <div 
                      key={index}
                      className={`flex items-center ${badge.bgColor} px-5 py-2 rounded-[6.25rem]`}
                    >
                      <span className={`text-lg font-medium ${badge.textColor}`}>
                        {badge.text}
                      </span>
                    </div>
                  ))}
              ...
              <div className="bg-[#F8F8F8] rounded-[1.375rem] p-8 h-full">
                ...
                <div className="mt-6 p-6 bg-[#E3EDFF] rounded-[0.625rem]">
                  <p className="text-lg leading-[129%] text-[#000000]">
