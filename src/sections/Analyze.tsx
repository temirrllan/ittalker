...
const stats = [
    {
      title: "3 года",
      description: "занимает путь от старта в профессии до middle+ согласно исследованиям CV от hh.kz",
    },
    {
      title: "3000+",
      description: "открытых вакансий в ЕАЭС согласно данным hh.kz",
    },
    {
      title: "70+",
    ...
    {
      title: "3000$",
      description: "Средняя зарплата системного аналитика уровня Senior согласно исследованиям CV от hh.kz",
    },
  ];
